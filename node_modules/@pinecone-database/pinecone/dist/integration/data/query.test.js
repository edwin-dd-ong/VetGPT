...
describe('query', function () {
    ...
    test('query by id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var recordsToUpsert, topK, assertions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, test_helpers_1.assertWithRetries)(function () { return ns.query({ id: '0', topK: topK }); }, assertions)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('query when topK is greater than number of records', function () { return __awaiter(void 0, void 0, void 0, function () {
        var numberOfRecords, recordsToUpsert, topK, assertions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    numberOfRecords = 3;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, test_helpers_1.assertWithRetries)(function () { return ns.query({ id: '100', topK: topK }); }, assertions)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('query with includeValues: true', function () { return __awaiter(void 0, void 0, void 0, function () {
        var recordsToUpsert, queryVec, assertions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    recordsToUpsert = (0, test_helpers_1.generateRecords)(5, 3);
